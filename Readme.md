...
This fork has just a minor change in the user profile photo size (changed from 512px to 64px). Please use the [original repo](https://github.com/Tyrrrz/DiscordChatExporter) instead.
